...
class Constants(Enum):
    ...
    dicionario = [
        # Este dicionário foi
        {
            "nome_tabela": "microdados_operacao",
        ...
        {
            "nome_tabela": "operacoes_desclassificadas",
