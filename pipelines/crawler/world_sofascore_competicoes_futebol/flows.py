...
from pipelines.crawler.world_sofascore_competicoes_futebol.tasks import (
...
with Flow(
    ...
    code_owners=["luiz"],
) as flow_world_sofascore_competicoes_futebol:
    # Parameters
...
flow_world_sofascore_competicoes_futebol.storage = GCS(
    constants.GCS_FLOWS_BUCKET.value
)
flow_world_sofascore_competicoes_futebol.run_config = KubernetesRun(
