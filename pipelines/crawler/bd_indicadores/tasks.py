...
from pipelines.crawler.bd_indicadores.utils import (
    GA4RealTimeReport,
    connect_to_endpoint,
...
def get_storage_blobs(dataset_id: str, table_id: str, mode: str = "staging"):
    """Lista blobs de uma pasta no GCS (substitui função removida do utils antigo)."""
    ...
    return list(
        ...
        .list_blobs(prefix=f"{mode}/{dataset_id}/{table_id}/")
    )
