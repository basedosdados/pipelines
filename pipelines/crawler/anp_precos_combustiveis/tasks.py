"""
Tasks for br_anp_precos_combustiveis — Prefect 3.
"""

import pandas as pd
from prefect import task

from pipelines.crawler.anp_precos_combustiveis.constants import (
    constants as anp_constants,
)
from pipelines.crawler.anp_precos_combustiveis.utils import (
    creating_column_ano,
    download_files,
    get_id_municipio,
