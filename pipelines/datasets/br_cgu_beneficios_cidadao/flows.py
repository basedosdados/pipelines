...
br_cgu_beneficios_cidadao__novo_bolsa_familia.schedule = every_day_novo_bolsa_familia,
...
br_cgu_beneficios_cidadao__garantia_safra.name = "br_cgu_beneficios_cidadao.garantia_safra"
br_cgu_beneficios_cidadao__garantia_safra.code_owners = ["trick"]
br_cgu_beneficios_cidadao__garantia_safra.storage = GCS(constants.GCS_FLOWS_BUCKET.value)
br_cgu_beneficios_cidadao__garantia_safra.run_config = KubernetesRun(image=constants.DOCKER_IMAGE.value)
...
br_cgu_beneficios_cidadao__bpc.run_config = KubernetesRun(image=constants.DOCKER_IMAGE.value)
