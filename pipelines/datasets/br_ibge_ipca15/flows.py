...
br_ibge_ipca15_mes_categoria_rm.schedule = schedule_br_ibge_ipca15_mes_categoria_rm

br_ibge_ipca15_mes_categoria_municipio = deepcopy(flow_ibge_inflacao_mes_municipio_)
