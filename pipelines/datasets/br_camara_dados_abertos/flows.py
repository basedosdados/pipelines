...
br_camara_dados_abertos__votacao_orientacao_bancada = deepcopy(
    flow_camara_dados_abertos
)
...
br_camara_dados_abertos__votacao_parlamentar = deepcopy(
    flow_camara_dados_abertos
)
...
br_camara_dados_abertos__votacao_proposicao = deepcopy(
    flow_camara_dados_abertos
)
...
br_camara_dados_abertos__deputado_ocupacao = deepcopy(
    flow_camara_dados_abertos
)
...
br_camara_dados_abertos__deputado_profissao = deepcopy(
    flow_camara_dados_abertos
)
...
br_camara_dados_abertos__proposicao_microdados = deepcopy(
    flow_camara_dados_abertos
)
...
br_camara_dados_abertos__evento_presenca_deputado = deepcopy(
    flow_camara_dados_abertos
)
...
br_camara_dados_abertos__evento_requerimento = deepcopy(
    flow_camara_dados_abertos
)
...
br_camara_dados_abertos__licitacao_contrato = deepcopy(
    flow_camara_dados_abertos
)
...
br_camara_dados_abertos__licitacao_proposta = deepcopy(
    flow_camara_dados_abertos
)
