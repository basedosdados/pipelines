"""Prefect 3 tasks for au_apra_superannuation — thin wrappers over utils.py."""

from pathlib import Path

from prefect import task

from pipelines.datasets.au_apra_superannuation.utils import (
    clean_all,
    download_workbook,
)
...
def download_superannuation(work_dir: str) -> str:
    """Download the current APRA superannuation performance workbook.
...
@task
def clean_superannuation(work_dir: str, input_dir: str) -> dict:
    """Build all four tables from the downloaded workbook.
