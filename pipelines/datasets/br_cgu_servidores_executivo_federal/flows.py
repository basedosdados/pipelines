...
br_cgu_servidores_federal__afastamentos = deepcopy(
    flow_cgu_servidores_publicos
)
...
br_cgu_servidores_federal__afastamentos.run_config = KubernetesRun(
...
br_cgu_servidores_federal__cadastro_aposentados = deepcopy(
    flow_cgu_servidores_publicos
)
...
br_cgu_servidores_federal__cadastro_aposentados.run_config = KubernetesRun(
    image=constants.DOCKER_IMAGE.value
)
br_cgu_servidores_federal__cadastro_aposentados.schedule = (
    every_day_cadastro_aposentados
)

# ! br_cgu_servidores_federal__cadastro_pensionistas

br_cgu_servidores_federal__cadastro_pensionistas = deepcopy(
    flow_cgu_servidores_publicos
)
...
br_cgu_servidores_federal__cadastro_pensionistas.run_config = KubernetesRun(
    image=constants.DOCKER_IMAGE.value
)
br_cgu_servidores_federal__cadastro_pensionistas.schedule = (
    every_day_cadastro_pensionistas
)

# ! br_cgu_servidores_federal__cadastro_reserva_reforma_militares

br_cgu_servidores_federal__cadastro_reserva_reforma_militares = deepcopy(
    flow_cgu_servidores_publicos
)
br_cgu_servidores_federal__cadastro_reserva_reforma_militares.name = (
    "br_cgu_servidores_executivo_federal.cadastro_reserva_reforma_militares"
)
br_cgu_servidores_federal__cadastro_reserva_reforma_militares.code_owners = [
    "trick"
]
br_cgu_servidores_federal__cadastro_reserva_reforma_militares.storage = GCS(
    constants.GCS_FLOWS_BUCKET.value
)
br_cgu_servidores_federal__cadastro_reserva_reforma_militares.run_config = (
    KubernetesRun(image=constants.DOCKER_IMAGE.value)
)
br_cgu_servidores_federal__cadastro_reserva_reforma_militares.schedule = (
    every_day_cadastro_reserva_reforma_militares
)

# ! br_cgu_servidores_federal__cadastro_servidores

br_cgu_servidores_federal__cadastro_servidores = deepcopy(
    flow_cgu_servidores_publicos
)
...
br_cgu_servidores_federal__cadastro_servidores.run_config = KubernetesRun(
    image=constants.DOCKER_IMAGE.value
)
br_cgu_servidores_federal__cadastro_servidores.schedule = (
    every_day_cadastro_servidores
)
...
br_cgu_servidores_federal__observacoes.run_config = KubernetesRun(
    image=constants.DOCKER_IMAGE.value
)
...
br_cgu_servidores_federal__remuneracao.run_config = KubernetesRun(
    image=constants.DOCKER_IMAGE.value
)
