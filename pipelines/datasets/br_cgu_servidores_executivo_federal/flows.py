...
with Flow(
    ...
    with case(table_is_available(outputs_path_by_table, "aposentados_cadastro"), True):
        create_table_and_upload_to_gcs(
    ...
    with case(table_is_available(outputs_path_by_table, "pensionistas_cadastro"), True):
        create_table_and_upload_to_gcs(
    ...
    with case(table_is_available(outputs_path_by_table, "servidores_cadastro"), True):
        create_table_and_upload_to_gcs(
    ...
    with case(
        table_is_available(outputs_path_by_table, "reserva_reforma_militares_cadastro"),
        True,
    ):
        create_table_and_upload_to_gcs(
