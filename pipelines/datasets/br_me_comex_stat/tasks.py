                            ...
                            for mes in [*range(1, 13)]:
                                ...
                                for uf in constants.UF.value:   
                                    ...
                                    if 'municipio' in table:
                                        ...
                                        df_partition.drop(['ano', 'mes', 'sigla_uf'], axis=1, inplace=True)

                                        df_partition.to_csv(constants.PATH.value + 'output/' + f'{table}/ano={ano}/mes={mes}/sigla_uf={uf}/{table}.csv',
                                        index=False,
                                        encoding='utf-8', 
                                        na_rep=''
                                        )
                        ...
                        for ano in [*range(1997, 2023)]:
                            for mes in [*range(1, 13)]:
                                ...
                                if 'ncm' in table:
                                    ...
                                    df_partition.to_csv(constants.PATH.value + 'output/' + f'{table}/ano={ano}/mes={mes}/{table}.csv',
                                    index=False,
                                    encoding='utf-8', 
                                    na_rep=''
                                    )
