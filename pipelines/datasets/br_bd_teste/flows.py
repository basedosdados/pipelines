...
datasets_br_bd_teste_flow.storage = GCS(constants.GCS_FLOWS_BUCKET.value)
datasets_br_bd_teste_flow.run_config = KubernetesRun(image=constants.DOCKER_IMAGE.value)
