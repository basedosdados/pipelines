...
# from pipelines.datasets.br_ms_sim.schedules import every_two_weeks
...
) as datasets_br_ms_sim_flow:
    say_hello()

datasets_br_ms_sim_flow.storage = GCS(constants.GCS_FLOWS_BUCKET.value)
datasets_br_ms_sim_flow.run_config = KubernetesRun(image=constants.DOCKER_IMAGE.value)
