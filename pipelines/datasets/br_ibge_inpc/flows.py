...
from pipelines.datasets.br_ibge_inpc.schedules import (
    br_ibge_inpc_mes_categoria_brasil_every_month,
    br_ibge_inpc_mes_categoria_rm_every_month,
    br_ibge_inpc_mes_categoria_municipio_every_month,
    br_ibge_inpc_mes_brasil_every_month,
)
...
br_ibge_inpc_mes_categoria_rm.schedule = br_ibge_inpc_mes_categoria_rm_every_month

br_ibge_inpc_mes_categoria_municipio = deepcopy(flow_ibge_inflacao_mes_municipio)
br_ibge_inpc_mes_categoria_municipio.name = "br_ibge_inpc.mes_categoria_brasil"
...
br_ibge_inpc_mes_brasil.name = "br_ibge_inpc.mes_categoria_brasil"
