...
from pipelines.datasets.br_bcb_indicadores.tasks import get_data, treat_data
...
with Flow(
    ...
    input_filepath = get_data(table_id=table_id, upstream_tasks=[rename_flow_run])

    output_filepath = treat_data(table_id=table_id, upstream_tasks=[input_filepath])
