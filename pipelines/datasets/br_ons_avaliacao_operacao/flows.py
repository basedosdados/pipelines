...
from prefect.storage import GCS
from pipelines.constants import constants
from pipelines.datasets.br_ons_avaliacao_operacao.tasks import say_hello

# from pipelines.datasets.br_ons_avaliacao_operacao.schedules import every_two_weeks
...
) as datasets_br_ons_avaliacao_operacao_flow:
    say_hello()

datasets_br_ons_avaliacao_operacao_flow.storage = GCS(constants.GCS_FLOWS_BUCKET.value)
datasets_br_ons_avaliacao_operacao_flow.run_config = KubernetesRun(
