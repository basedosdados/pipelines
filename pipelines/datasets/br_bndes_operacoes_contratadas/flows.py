...
with Flow(
    name="br_bndes_operacoes_contratadas__operacoes_contratadas_forma_direta_e_indireta_nao_automatica", code_owners=["equipe_dados"]
) as br_bndes_operacoes_contratadas_direta_indireta_nao_automatica:
    # Parameters
    dataset_id = Parameter(
        "dataset_id", 
        default="br_bndes_operacoes_contratadas", 
        required=False
    )
    table_id = Parameter(
        "table_id", 
    ...
    dbt_alias = Parameter(
        "dbt_alias", default=True, required=False
    )
