...
def extract_file_records(
    ...
    """
    Converte as linhas do DataFrame de metadados em uma lista de dicts
    (valores escalares) ANTES do fan-out em tasks paralelas — cada task de
    download/processamento passa a receber apenas seu próprio file_name e
    reference_date, nunca o DataFrame inteiro compartilhado.
    """
    return df_metadata[[filename_col, reference_date_col]].to_dict("records")
