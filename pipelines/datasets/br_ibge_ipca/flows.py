...
br_ibge_ipca_mes_categoria_rm.schedule = br_ibge_ipca_mes_categoria_rm_every_month

br_ibge_ipca_mes_categoria_municipio = deepcopy(flow_ibge_inflacao_mes_municipio)
br_ibge_ipca_mes_categoria_municipio.name = "br_ibge_ipca.mes_categoria_brasil"
...
br_ibge_ipca_mes_brasil.name = "br_ibge_ipca.mes_categoria_brasil"
