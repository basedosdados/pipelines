...
br_ibge_ipca_mes_categoria_brasil.schedule = schedule_br_ibge_ipca_mes_categoria_brasil
...
br_ibge_ipca_mes_categoria_rm.code_owners = ["Gabriel Pisa"]
...
br_ibge_ipca_mes_brasil.code_owners = ["Gabriel Pisa"]
