...
class constants(Enum):  # pylint: disable=c0103
    ...
    KWARGS_LIST = [{'class_':'ui-pdp-title'}, { 'class_':'ui-pdp-review__amount'} , { 'class_':'andes-money-amount__discount'}, { 'class_':'ui-pdp-color--BLACK ui-pdp-family--REGULAR ui-pdp-media__title ui-pdp-media__title--on-hover'}, { 'class_': 'ui-review-capability__rating__average ui-review-capability__rating__average--desktop'}]
