...
br_anatel_telefonia_movel__densidade_municipio = deepcopy(flow_anatel_telefonia_movel)
...
br_anatel_telefonia_movel__densidade_brasil = deepcopy(flow_anatel_telefonia_movel)
