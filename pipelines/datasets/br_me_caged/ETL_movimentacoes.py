...
for year_month in list(download_dict.keys()):
    ...
    year = year_month[0:4]
    save_path = "home/isadora/BasesdosDados/Data/"
    
    caged_novo.download_data(save_path, f'{download_dict[year_month]}')
      
    file_name =  f"CAGEDMOV" + year_month + ".7z"
    file_path = "home/isadora/BasesdosDados/Data/"
    ...
    save_clean_path = "home/isadora/BasesdosDados/Data/"
