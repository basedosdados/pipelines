...
br_ms_cnes_dados_complementares.schedule = (
    schedule_br_ms_cnes_dados_complementares
)
...
br_ms_cnes_servico_especializado.schedule = (
    schedule_br_ms_cnes_servico_especializado
)
...
br_ms_cnes_estabelecimento_filantropico = deepcopy(flow_cnes)
...
# br_ms_cnes_regra_contratual.schedule = schedule.schedule_br_ms_cnes_regra_contratual
