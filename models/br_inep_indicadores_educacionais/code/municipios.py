...
def municipios(ano: int) -> None:
    ...
    INPUT = os.path.join(os.getcwd(), "tmp", "municipios", "input")  # noqa: N806
    OUTPUT = os.path.join(os.getcwd(), "tmp", "municipios", "output")  # noqa: N806
    ...
    COL_ID_MUNICIPIO_RENAME = {"CO_MUNICIPIO": "id_municipio"}  # noqa: N806
    UNSUED_COLS = ["NO_REGIAO", "SG_UF", "NO_MUNICIPIO"]  # noqa: N806
