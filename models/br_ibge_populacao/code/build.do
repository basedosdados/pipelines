...
cd "~/Dropbox/Academic/Data/Brazil/Municipios/Populacao"
...
import excel "raw/2009/UF_Municipio.xls", clear
drop in 1/5
drop in 5566/5571
gen aux = strlen(C)
gen id_municipio = ""
...
import excel "raw/2011/tab_Municipios_TCU.xls", clear
drop in 1/7
drop in 5566/65528
gen id_municipio = B + C
gen id_municipio_6 = substr(id_municipio, 1, 6)
...
import excel "raw/2022/tabela631.xlsx", clear
drop in 1/4
drop in 5571
gen id_municipio = A
gen id_municipio_6 = substr(id_municipio, 1, 6)
ren B municipio
split municipio, l(1) p(" (")
drop municipio
ren municipio1 municipio
ren E populacao
destring, replace
gen ano = 2022
keep  id_municipio_6 id_municipio municipio ano populacao
...
import excel "raw/2023/POP_TCU_2023_Municipios_POP2022_Malha2023.xls", clear
drop in 1/2
drop in 5571/5603
gen id_municipio = B + C
gen id_municipio_6 = substr(id_municipio, 1, 6)
...
keep  id_municipio_6 id_municipio municipio ano populacao
order id_municipio_6 id_municipio municipio ano populacao
save "tmp/2023.dta", replace

//-----------------//
// 2024
//-----------------//

import excel "raw/2024/estimativa_dou_2024.xls", clear sheet("MUNICÍPIOS")
drop in 1/2
drop in 5571/5573
gen id_municipio = B + C
gen id_municipio_6 = substr(id_municipio, 1, 6)
...
keep  id_municipio_6 id_municipio municipio ano populacao
order id_municipio_6 id_municipio municipio ano populacao
save "tmp/2024.dta", replace

//-----------------//
// 2025
//-----------------//

import excel "raw/2025/estimativa_dou_2025.xls", clear sheet("Municípios")
drop in 1/2
drop in 5572/5574
gen id_municipio = B + C
gen id_municipio_6 = substr(id_municipio, 1, 6)
...
foreach ano of numlist 1992(1)1999 2001(1)2009 2011(1)2025 {
