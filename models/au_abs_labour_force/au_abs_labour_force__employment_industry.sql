...
select
    ...
    safe_cast(industry_group_code as string) industry_group_code,
...
from {{ set_datalake_project("au_abs_labour_force_staging.employment_industry") }} as t
