{{
    config(
        ...
        alias="employment_industry_hours",
        materialized="table",
        partition_by={
            "field": "year",
            "data_type": "int64",
...
select
    ...
    safe_cast(hours_measure as string) hours_measure,
...
from
    {{ set_datalake_project("au_abs_labour_force_staging.employment_industry_hours") }}
    as t
