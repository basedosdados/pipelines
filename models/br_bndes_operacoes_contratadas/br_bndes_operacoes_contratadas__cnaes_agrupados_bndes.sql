{{ config(alias="cnaes_agrupados_bndes", schema="br_bndes_operacoes_contratadas", materialized="table") }}
select
...
from {{ set_datalake_project("br_bndes_operacoes_contratadas_staging.cnaes_agrupados_bndes") }} as t
