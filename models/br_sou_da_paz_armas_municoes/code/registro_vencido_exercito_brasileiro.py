...
def registro_vencido_exercito_brasileiro(
    ...
    df.to_csv(
        constants.tabelas.value["registro_vencido_exercito_brasileiro"][
            "save_table"
        ],
        sep=",",
        encoding="utf-8",
...
if __name__ == "__main__":
    ...
    tb = bd.Table(
        ...
        table_id="registro_vencido_exercito_brasileiro",
        bucket_name="basedosdados-consultoria",
        mode="sou_da_paz",
    )

    tb.create(
        path=constants.tabelas.value["registro_vencido_exercito_brasileiro"][
            "save_table"
        ],
