...
def nova_entidade_exercito_brasileiro(
    ...
    create_output()
    df.to_csv(
        constants.tabelas.value["nova_entidade_exercito_brasileiro"][
            "save_table"
        ],
        sep=",",
        encoding="utf-8",
...
if __name__ == "__main__":
    ...
    tb = bd.Table(
        ...
        table_id="nova_entidade_exercito_brasileiro",
    )

    tb.create(
        path=constants.tabelas.value["nova_entidade_exercito_brasileiro"][
            "save_table"
        ],
