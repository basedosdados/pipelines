...
def registro_ativo_entidade_exercito_brasileiro(
    ...
    create_output()
    df.to_csv(
        constants.tabelas.value["registro_ativo_entidade_exercito_brasileiro"][
            "save_table"
        ],
        sep=",",
        encoding="utf-8",
...
if __name__ == "__main__":
    ...
    tb = bd.Table(
        ...
        table_id="registro_ativo_entidade_exercito_brasileiro",
