...
select
    ...
    safe_cast(flag_briefwahl_only as string) flag_briefwahl_only,
    safe_cast(flag_no_valid_votes as string) flag_no_valid_votes,
...
from {{ set_datalake_project("us_nature_gerda_staging.state_municipality") }} as t
