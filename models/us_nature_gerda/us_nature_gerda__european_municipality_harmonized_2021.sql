{{
    config(
        ...
        alias="european_municipality_harmonized_2021",
        materialized="table",
        partition_by={
            "field": "year",
            "data_type": "int64",
...
select
    ...
    safe_cast(flag_turnout_above_1 as string) flag_turnout_above_1,
...
from
    {{
        set_datalake_project(
            "us_nature_gerda_staging.european_municipality_harmonized_2021"
        )
    }} as t
