...
*Auto-generated by `python -m diagnostics report` on 2026-07-29.*

**Summary:** 392 OK · 59 WARN · 0 FAIL · 0 without official layout (site x year checks).
...
#### WARN: `candidatos` — MISSING_KEY

- block: `sub/candidates.py::_parse_schema` line 43
- years: 1994, 1996, 2014, 2018, 2020, 2022, 2024
- layout source: header

| ano | raw col | code maps to | official variable |
|---|---|---|---|
| 1994 | `ds_detalhe_situacao_cand` | `situacao` | *(absent)* |
| 1994 | `ds_nacionalidade` | `nacionalidade` | *(absent)* |
| 1994 | `nm_municipio_nascimento` | `municipio_nascimento` | *(absent)* |

#### WARN: `detalhes_votacao_municipio_zona` — MISSING_KEY

- block: `sub/voting_details_mun_zone.py::_parse_named` line 66
- years: 1994, 1996, 1998, 2000, 2002, 2004, 2006, 2008, 2010, 2012, 2014, 2016, 2018, 2020, 2022, 2024
- layout source: header

| ano | raw col | code maps to | official variable |
|---|---|---|---|
| 1994 | `qt_secoes` | `secoes` | *(absent)* |
| 1994 | `qt_aptos_tot` | `aptos_totalizadas` | *(absent)* |
| 1994 | `qt_secoes_tot` | `secoes_totalizadas` | *(absent)* |
| 1994 | `qt_votos_nominais` | `votos_nominais` | *(absent)* |
| 1994 | `qt_votos_legenda` | `votos_legenda` | *(absent)* |
...
#### WARN: `partidos` — MISSING_KEY

- block: `sub/parties.py::_parse_named` line 42
- years: 1990
- layout source: override

| ano | raw col | code maps to | official variable |
|---|---|---|---|
| 1990 | `nr_turno` | `turno` | *(absent)* |
| 1990 | `ds_eleicao` | `tipo_eleicao` | *(absent)* |
| 1990 | `sg_uf` | `sigla_uf` | *(absent)* |
| 1990 | `sg_ue` | `id_municipio_tse` | *(absent)* |
| 1990 | `ds_cargo` | `cargo` | *(absent)* |
| 1990 | `tp_agremiacao` | `tipo_agremiacao` | *(absent)* |
| 1990 | `nr_partido` | `numero` | *(absent)* |
| 1990 | `sg_partido` | `sigla` | *(absent)* |
| 1990 | `nm_partido` | `nome` | *(absent)* |
| 1990 | `nm_coligacao` | `nome_coligacao` | *(absent)* |
| 1990 | `ds_composicao_coligacao` | `composicao_coligacao` | *(absent)* |
| 1990 | `sq_coligacao` | `sequencial_coligacao` | *(absent)* |

#### WARN: `perfil_eleitorado_municipio_zona` — MISSING_KEY

- block: `sub/voter_profile_mun_zone.py::build_perfil_mun_zona` line 27
- years: 2008, 2010, 2012, 2014, 2016, 2020, 2022, 2024
- layout source: header
...
#### WARN: `perfil_eleitorado_municipio_zona` — NAMED_AFFINITY_MISMATCH
...
| ano | raw col | code maps to | official variable |
|---|---|---|---|
| 2022 | `qt_eleitores_nome_social` | `eleitores_inclusao_nome_social` | *(absent)* |
