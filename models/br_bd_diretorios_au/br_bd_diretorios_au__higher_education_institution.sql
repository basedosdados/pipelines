...
select
    safe_cast(id_higher_education_institution as string) id_higher_education_institution,
...
from
    {{ set_datalake_project("br_bd_diretorios_au_staging.higher_education_institution") }}
    as t
