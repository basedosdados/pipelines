...
select
    ...
    safe_cast(cancellation_date_of_flood_policy as date) cancellation_date_of_flood_policy,
    ...
    safe_cast(regular_emergency_program_indicator as string) regular_emergency_program_indicator,
    ...
    safe_cast(total_insurance_premium_of_the_policy as int64) total_insurance_premium_of_the_policy,
    safe_cast(cancellation_voidance_reason_code as string) cancellation_voidance_reason_code,
...
from
    {{ set_datalake_project("us_fema_openfema_staging.nfip_policy") }}
    as t
