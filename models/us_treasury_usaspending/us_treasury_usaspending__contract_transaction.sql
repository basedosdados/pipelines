...
select
    ...
    safe_cast(contract_transaction_unique_key as string) contract_transaction_unique_key,
    ...
    safe_cast(parent_award_modification_number as string) parent_award_modification_number,
    ...
    safe_cast(total_outlayed_amount_for_overall_award as float64) total_outlayed_amount_for_overall_award,
    safe_cast(base_and_exercised_options_value as float64) base_and_exercised_options_value,
    ...
    safe_cast(disaster_emergency_fund_codes_for_overall_award as string) disaster_emergency_fund_codes_for_overall_award,
    safe_cast(outlayed_amount_from_covid19_supplementals_for_overall_award as float64) outlayed_amount_from_covid19_supplementals_for_overall_award,
    safe_cast(obligated_amount_from_covid19_supplementals_for_overall_award as float64) obligated_amount_from_covid19_supplementals_for_overall_award,
    safe_cast(outlayed_amount_from_IIJA_supplemental_for_overall_award as float64) outlayed_amount_from_IIJA_supplemental_for_overall_award,
    safe_cast(obligated_amount_from_IIJA_supplemental_for_overall_award as float64) obligated_amount_from_IIJA_supplemental_for_overall_award,
    safe_cast(action_date as date) action_date,
    safe_cast(period_of_performance_start_date as date) period_of_performance_start_date,
    safe_cast(period_of_performance_current_end_date as date) period_of_performance_current_end_date,
    safe_cast(period_of_performance_potential_end_date as date) period_of_performance_potential_end_date,
    ...
    safe_cast(treasury_accounts_funding_this_award as string) treasury_accounts_funding_this_award,
    safe_cast(federal_accounts_funding_this_award as string) federal_accounts_funding_this_award,
    safe_cast(object_classes_funding_this_award as string) object_classes_funding_this_award,
    safe_cast(program_activities_funding_this_award as string) program_activities_funding_this_award,
    ...
    safe_cast(recipient_doing_business_as_name as string) recipient_doing_business_as_name,
    ...
    safe_cast(concat(substr(regexp_replace(prime_award_transaction_recipient_county_fips_code, r'\.0$', ''), 1, 2), lpad(substr(regexp_replace(prime_award_transaction_recipient_county_fips_code, r'\.0$', ''), 3), 3, '0')) as string) prime_award_transaction_recipient_county_fips_code,
    safe_cast(recipient_county_name as string) recipient_county_name,
    safe_cast(prime_award_transaction_recipient_state_fips_code as string) prime_award_transaction_recipient_state_fips_code,
    ...
    safe_cast(prime_award_transaction_recipient_cd_original as string) prime_award_transaction_recipient_cd_original,
    safe_cast(prime_award_transaction_recipient_cd_current as string) prime_award_transaction_recipient_cd_current,
    ...
    safe_cast(primary_place_of_performance_country_code as string) primary_place_of_performance_country_code,
    safe_cast(primary_place_of_performance_country_name as string) primary_place_of_performance_country_name,
    safe_cast(primary_place_of_performance_city_name as string) primary_place_of_performance_city_name,
    safe_cast(concat(substr(regexp_replace(prime_award_transaction_place_of_performance_county_fips_code, r'\.0$', ''), 1, 2), lpad(substr(regexp_replace(prime_award_transaction_place_of_performance_county_fips_code, r'\.0$', ''), 3), 3, '0')) as string) prime_award_transaction_place_of_performance_county_fips_code,
    safe_cast(primary_place_of_performance_county_name as string) primary_place_of_performance_county_name,
    safe_cast(prime_award_transaction_place_of_performance_state_fips_code as string) prime_award_transaction_place_of_performance_state_fips_code,
    safe_cast(primary_place_of_performance_state_code as string) primary_place_of_performance_state_code,
    safe_cast(primary_place_of_performance_state_name as string) primary_place_of_performance_state_name,
    safe_cast(primary_place_of_performance_zip_4 as string) primary_place_of_performance_zip_4,
    safe_cast(prime_award_transaction_place_of_performance_cd_original as string) prime_award_transaction_place_of_performance_cd_original,
    safe_cast(prime_award_transaction_place_of_performance_cd_current as string) prime_award_transaction_place_of_performance_cd_current,
    ...
    safe_cast(multiple_or_single_award_idv_code as string) multiple_or_single_award_idv_code,
    ...
    safe_cast(prime_award_base_transaction_description as string) prime_award_base_transaction_description,
    ...
    safe_cast(inherently_governmental_functions as string) inherently_governmental_functions,
    safe_cast(inherently_governmental_functions_description as string) inherently_governmental_functions_description,
    safe_cast(product_or_service_code as string) product_or_service_code,
    safe_cast(product_or_service_code_description as string) product_or_service_code_description,
    ...
    safe_cast(dod_claimant_program_description as string) dod_claimant_program_description,
    safe_cast(naics_code as string) naics_code,
    safe_cast(naics_description as string) naics_description,
    safe_cast(recovered_materials_sustainability_code as string) recovered_materials_sustainability_code,
    safe_cast(recovered_materials_sustainability as string) recovered_materials_sustainability,
    safe_cast(domestic_or_foreign_entity_code as string) domestic_or_foreign_entity_code,
    ...
    safe_cast(dod_acquisition_program_description as string) dod_acquisition_program_description,
    safe_cast(information_technology_commercial_item_category_code as string) information_technology_commercial_item_category_code,
    safe_cast(information_technology_commercial_item_category as string) information_technology_commercial_item_category,
    ...
    safe_cast(country_of_product_or_service_origin_code as string) country_of_product_or_service_origin_code,
    safe_cast(country_of_product_or_service_origin as string) country_of_product_or_service_origin,
    ...
    safe_cast(fair_opportunity_limited_sources_code as string) fair_opportunity_limited_sources_code,
    safe_cast(fair_opportunity_limited_sources as string) fair_opportunity_limited_sources,
    safe_cast(other_than_full_and_open_competition_code as string) other_than_full_and_open_competition_code,
    safe_cast(other_than_full_and_open_competition as string) other_than_full_and_open_competition,
    safe_cast(number_of_offers_received as int64) number_of_offers_received,
    safe_cast(commercial_item_acquisition_procedures_code as string) commercial_item_acquisition_procedures_code,
    safe_cast(commercial_item_acquisition_procedures as string) commercial_item_acquisition_procedures,
    safe_cast(small_business_competitiveness_demonstration_program as string) small_business_competitiveness_demonstration_program,
    safe_cast(simplified_procedures_for_certain_commercial_items_code as string) simplified_procedures_for_certain_commercial_items_code,
    safe_cast(simplified_procedures_for_certain_commercial_items as string) simplified_procedures_for_certain_commercial_items,
    ...
    safe_cast(price_evaluation_adjustment_preference_percent_difference as float64) price_evaluation_adjustment_preference_percent_difference,
    safe_cast(clinger_cohen_act_planning_code as string) clinger_cohen_act_planning_code,
    safe_cast(clinger_cohen_act_planning as string) clinger_cohen_act_planning,
    safe_cast(materials_supplies_articles_equipment_code as string) materials_supplies_articles_equipment_code,
    safe_cast(materials_supplies_articles_equipment as string) materials_supplies_articles_equipment,
    safe_cast(labor_standards_code as string) labor_standards_code,
    safe_cast(labor_standards as string) labor_standards,
    safe_cast(construction_wage_rate_requirements_code as string) construction_wage_rate_requirements_code,
    safe_cast(construction_wage_rate_requirements as string) construction_wage_rate_requirements,
    safe_cast(interagency_contracting_authority_code as string) interagency_contracting_authority_code,
    safe_cast(interagency_contracting_authority as string) interagency_contracting_authority,
    ...
    safe_cast(parent_award_single_or_multiple_code as string) parent_award_single_or_multiple_code,
    safe_cast(parent_award_single_or_multiple as string) parent_award_single_or_multiple,
    ...
    safe_cast(cost_accounting_standards_clause_code as string) cost_accounting_standards_clause_code,
    safe_cast(cost_accounting_standards_clause as string) cost_accounting_standards_clause,
    safe_cast(government_furnished_property_code as string) government_furnished_property_code,
    ...
    safe_cast(performance_based_service_acquisition_code as string) performance_based_service_acquisition_code,
    safe_cast(performance_based_service_acquisition as string) performance_based_service_acquisition,
    ...
    safe_cast(purchase_card_as_payment_method_code as string) purchase_card_as_payment_method_code,
    safe_cast(purchase_card_as_payment_method as string) purchase_card_as_payment_method,
    safe_cast(contingency_humanitarian_or_peacekeeping_operation_code as string) contingency_humanitarian_or_peacekeeping_operation_code,
    safe_cast(contingency_humanitarian_or_peacekeeping_operation as string) contingency_humanitarian_or_peacekeeping_operation,
    safe_cast(alaskan_native_corporation_owned_firm as string) alaskan_native_corporation_owned_firm,
    safe_cast(american_indian_owned_business as string) american_indian_owned_business,
    safe_cast(indian_tribe_federally_recognized as string) indian_tribe_federally_recognized,
    safe_cast(native_hawaiian_organization_owned_firm as string) native_hawaiian_organization_owned_firm,
    ...
    safe_cast(service_disabled_veteran_owned_business as string) service_disabled_veteran_owned_business,
    ...
    safe_cast(economically_disadvantaged_women_owned_small_business as string) economically_disadvantaged_women_owned_small_business,
    safe_cast(joint_venture_women_owned_small_business as string) joint_venture_women_owned_small_business,
    safe_cast(joint_venture_economic_disadvantaged_women_owned_small_bus as string) joint_venture_economic_disadvantaged_women_owned_small_bus,
    safe_cast(minority_owned_business as string) minority_owned_business,
    safe_cast(subcontinent_asian_asian_indian_american_owned_business as string) subcontinent_asian_asian_indian_american_owned_business,
    safe_cast(asian_pacific_american_owned_business as string) asian_pacific_american_owned_business,
    safe_cast(black_american_owned_business as string) black_american_owned_business,
    safe_cast(hispanic_american_owned_business as string) hispanic_american_owned_business,
    ...
    safe_cast(contracting_officers_determination_of_business_size as string) contracting_officers_determination_of_business_size,
    safe_cast(contracting_officers_determination_of_business_size_code as string) contracting_officers_determination_of_business_size_code,
    safe_cast(emerging_small_business as string) emerging_small_business,
    safe_cast(community_developed_corporation_owned_firm as string) community_developed_corporation_owned_firm,
    ...
    safe_cast(federally_funded_research_and_development_corp as string) federally_funded_research_and_development_corp,
    ...
    safe_cast(inter_municipal_local_government as string) inter_municipal_local_government,
    ...
    safe_cast(school_district_local_government as string) school_district_local_government,
    ...
    safe_cast(corporate_entity_not_tax_exempt as string) corporate_entity_not_tax_exempt,
    safe_cast(corporate_entity_tax_exempt as string) corporate_entity_tax_exempt,
    safe_cast(partnership_or_limited_liability_partnership as string) partnership_or_limited_liability_partnership,
    ...
    safe_cast(community_development_corporation as string) community_development_corporation,
    ...
    safe_cast(receives_contracts_and_financial_assistance as string) receives_contracts_and_financial_assistance,
    safe_cast(airport_authority as string) airport_authority,
    safe_cast(council_of_governments as string) council_of_governments,
    safe_cast(housing_authorities_public_tribal as string) housing_authorities_public_tribal,
    ...
    safe_cast(other_not_for_profit_organization as string) other_not_for_profit_organization,
    ...
    safe_cast(state_controlled_institution_of_higher_learning as string) state_controlled_institution_of_higher_learning,
    ...
    safe_cast(alaskan_native_servicing_institution as string) alaskan_native_servicing_institution,
    safe_cast(native_hawaiian_servicing_institution as string) native_hawaiian_servicing_institution,
    ...
    safe_cast(self_certified_small_disadvantaged_business as string) self_certified_small_disadvantaged_business,
    ...
    safe_cast(historically_underutilized_business_zone_hubzone_firm as string) historically_underutilized_business_zone_hubzone_firm,
    safe_cast(sba_certified_8a_joint_venture as string) sba_certified_8a_joint_venture,
    safe_cast(highly_compensated_officer_1_name as string) highly_compensated_officer_1_name,
    safe_cast(highly_compensated_officer_1_amount as float64) highly_compensated_officer_1_amount,
    safe_cast(highly_compensated_officer_2_name as string) highly_compensated_officer_2_name,
    safe_cast(highly_compensated_officer_2_amount as float64) highly_compensated_officer_2_amount,
    safe_cast(highly_compensated_officer_3_name as string) highly_compensated_officer_3_name,
    safe_cast(highly_compensated_officer_3_amount as float64) highly_compensated_officer_3_amount,
    safe_cast(highly_compensated_officer_4_name as string) highly_compensated_officer_4_name,
    safe_cast(highly_compensated_officer_4_amount as float64) highly_compensated_officer_4_amount,
    safe_cast(highly_compensated_officer_5_name as string) highly_compensated_officer_5_name,
    safe_cast(highly_compensated_officer_5_amount as float64) highly_compensated_officer_5_amount,
