...
select
    ...
    safe_cast(t.dsc_naturezaobjeto as string) as natureza_objeto,
    ...
    safe_cast(t.data_iniciovigencia as date) as data_ini_vigencia,
    safe_cast(t.data_fimvigencia as date) as data_fim_vigencia,
    ...
    safe_cast(t.dsc_veiculopublicacao as string) as veiculo_publicacao,
