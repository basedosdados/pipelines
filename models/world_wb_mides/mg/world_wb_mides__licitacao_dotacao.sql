...
select
    ...
    ) as id_licitacao_dotacao_bd,
    safe_cast(p_licitacao.id_licitacao_bd as string) as id_licitacao_bd,
    safe_cast(t.seq_rec_licitacao as string) as id_rec_licitacao,
...
from {{ set_datalake_project("world_wb_mides_staging.raw_licitacao_dotacao_mg") }} as t
