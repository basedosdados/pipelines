...
select
    ...
    safe_cast(
        concat(
            ...
            ' ',
            ifnull(t.num_doc_responsavel, ''),
            ' ',
            ifnull(t.dsc_tipo_responsavel, '')
        ) as string
    ) as id_dispensa_responsavel_bd,
    safe_cast(p_dispensa.id_dispensa_bd as string) as id_dispensa_bd,
    safe_cast(t.seq_resp_dispensa as string) as id_resp_dispensa,
    safe_cast(t.seq_dispensa as string) as id_dispensa,
    safe_cast(t.orgao as string) as orgao,
    safe_cast(t.dsc_tipo_responsavel as string) as tipo_responsavel,
    safe_cast(t.num_doc_responsavel as string) as numero_doc_responsavel,
    safe_cast(t.dsc_nome_responsavel as string) as nome_responsavel
from
    {{ set_datalake_project("world_wb_mides_staging.raw_dispensa_responsavel_mg") }}
    as t
