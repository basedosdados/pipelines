...
select
    ...
    -- sequence. `seq_item_dispensa` is appended so the key identifies a row, at the
...
from {{ set_datalake_project("world_wb_mides_staging.raw_dispensa_item_mg") }} as t
