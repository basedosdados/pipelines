...
select
    ...
    safe_cast(t.valor_perc_desconto as float64) as valor_percentual_desconto,
    safe_cast(t.valor_perc_taxa_adm as float64) as valor_percentual_taxa_administracao,
