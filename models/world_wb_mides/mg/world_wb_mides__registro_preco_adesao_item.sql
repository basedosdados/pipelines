...
{{
    config(
        alias="registro_preco_adesao_item",
...
select
    ...
    safe_cast(
        p_registro_preco_adesao.id_registro_preco_adesao_bd as string
    ) as id_registro_preco_adesao_bd,
...
left join
    p_registro_preco_adesao on t.seq_reg_adesao = p_registro_preco_adesao.seq_reg_adesao
