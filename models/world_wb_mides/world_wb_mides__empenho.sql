    ...
    (
        with
            empenhado_ce as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_empenho_ce") }} e
            ),
            anulacao_ce as (
                select
                    safe_cast(
                ...
                from {{ project_path("world_wb_mides_staging.raw_anulacao_ce") }}
                group by 1
            ),
            frequencia_ce as (
            ...
            empenhado_mg as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_empenho_mg") }}
            ),
            dlic as (
                select
                    id_empenho_bd,
            ...
            empenhado_pb as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_empenho_pb") }} e
                left join
                    {{ project_path("world_wb_mides_staging.aux_municipio_pb") }}m
                    on e.cd_ugestora = safe_cast(m.id_unidade_gestora as string)
                left join
                    {{ project_path("world_wb_mides_staging.aux_funcao") }}f
                    on e.de_funcao = f.nome_funcao
                left join
                    {{ project_path("world_wb_mides_staging.aux_subfuncao") }}sf
            ...
            anulacao_pb as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_estorno_pb") }} a
                left join
                    {{ project_path("world_wb_mides_staging.aux_municipio_pb") }}m
            ...
            empenho_pe as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_empenho_pe") }} e
                left join
                    {{ project_path("world_wb_mides_staging.aux_municipio_pe") }}m
                    on e.nomeunidadegestora = m.nomeunidadegestora
                left join
                    {{ project_path("world_wb_mides_staging.aux_funcao") }}fun
                    on upper(
                        trim(
                            replace(
                                replace(
                    ...
                    = upper(nome_funcao)
                left join
                    {{ project_path("world_wb_mides_staging.aux_subfuncao") }}sub
            ...
            empenho_pr as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_empenho_pr") }} e
                left join
            ...
            empenhado_rs as (
                select
                    ...
                    safe_cast(vl_empenho as float64) as valor_inicial
                from {{ project_path("world_wb_mides_staging.raw_despesa_rs") }} as c
                left join
                    {{ project_path("world_wb_mides_staging.aux_orgao_rs") }} as a
            ...
            empenhado_sp as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_despesa_sp") }} e
                left join
                    {{ project_path("world_wb_mides_staging.aux_municipio_sp") }}m
                    on m.ds_orgao = e.ds_orgao
                left join
                    {{ project_path("world_wb_mides_staging.aux_funcao") }}
                    on ds_funcao_governo = upper(nome_funcao)
                left join
                    {{ project_path("world_wb_mides_staging.aux_subfuncao") }}
            ...
            anulacao as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_despesa_sp") }} a
                left join
                    {{ project_path("world_wb_mides_staging.aux_municipio_sp") }}m
            ...
            reforco as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_despesa_sp") }} r
                left join
                    {{ project_path("world_wb_mides_staging.aux_municipio_sp") }}m
            ...
            empenhado_rj as (
                select
                    ...
                    round(safe_cast(valor as float64), 2) as valor_inicial,
                from {{ project_path("world_wb_mides_staging.raw_empenho_rj") }}
            ...
            anulacao_rj as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_anulacao_rj") }}
            ...
            empenho_df as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_empenho_df") }}
            ),
            empenhado_sc as (
                select
                ...
                from {{ project_path("world_wb_mides_staging.raw_empenho_sc") }}
            ),
            frequencia_sc as (
                select id_empenho_bd, count(id_empenho_bd) as frequencia_id
                from empenhado_sc
