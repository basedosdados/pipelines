    ...
    (
        with
            liquidacao_ce as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_liquidacao_ce") }} l
                left join
            ...
            liquidacao_mg as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_liquidacao_mg") }} as l
                left join
            ...
            liquidacao_pb as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_liquidacao_pb") }} l
                left join
            ...
            liquidacao_pr as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_liquidacao_pr") }} l
                left join
            ...
            liquidacao_pe as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_liquidacao_pe") }} l
                left join
            ...
            liquidacao_rj as (
                select
                    ...
                    round(safe_cast(0 as float64), 2) as valor_ajuste,
                    round(safe_cast(valor as float64), 2) as valor_final
                from {{ project_path("world_wb_mides_staging.raw_liquidacao_rj") }}
            ...
            liquidacao_df as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_liquidacao_df") }}
            ),
            liquidado_sc as (
                select
