    ...
    (
        with
            empenho_ce as (
                ...
                left join
                    {{ project_path("world_wb_mides_staging.aux_municipio_ce") }}m
            ...
            pago_ce as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_pagamento_ce") }} p
                left join
                    {{ project_path("world_wb_mides_staging.aux_municipio_ce") }}m
            ...
            pagamento_mg as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_pagamento_mg") }} as p
                left join
                    {{ project_path("world_wb_mides_staging.raw_rsp_mg") }} as r
            ...
            pago_pb as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_pagamento_pb") }} p
                left join
                    {{ project_path("world_wb_mides_staging.raw_empenho_pb") }}e
            ...
            pagamento_pe as (
                select
                    ...
                    round(safe_cast(0 as float64), 2) as valor_liquido_recebido,
                from {{ project_path("world_wb_mides_staging.raw_pagamento_pe") }} p
                inner join
            ...
            pagamento_pr as (
                select
                    ...
                    round(safe_cast(0 as float64), 2) as valor_liquido_recebido,
                from {{ project_path("world_wb_mides_staging.raw_pagamento_pr") }} p
                left join
                    {{ project_path("world_wb_mides_staging.raw_empenho_pr") }}e
            ...
            pagamento_rj as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_pagamento_rj") }}
            ...
            pagamento_df as (
                ...
                from {{ project_path("world_wb_mides_staging.raw_pagamento_df") }}
            ),
            pago_sc as (
                select
