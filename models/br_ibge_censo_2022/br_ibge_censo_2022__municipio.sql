...
with
    domicilio_morador as (
        ...
        from {{ project_path("br_ibge_censo_2022_staging.municipio") }}
    ),
    ...
    area as (
        ...
        from {{ project_path("br_ibge_censo_2022_staging.municipio_area") }} as t
    ),
    ...
    indigenas as (
        ...
        from {{ project_path("br_ibge_censo_2022_staging.municipio_indigenas") }}
        group by 1, 2
    ),
    ...
    quilombolas as (
        ...
        from {{ project_path("br_ibge_censo_2022_staging.municipio_quilombolas") }}
        group by 1, 2
    ),
...
left join
    {{ project_path("br_ibge_censo_2022_staging.auxiliary_table") }} as auxiliary_table
