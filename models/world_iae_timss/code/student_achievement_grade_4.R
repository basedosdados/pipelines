...
write.csv(world_iae_timss_student_achievement_grade_4, "~/BD/timms/timms_2023/tabelas/grade_4/world_iae_timss_student_achievement_grade_4.csv", row.names = FALSE)
