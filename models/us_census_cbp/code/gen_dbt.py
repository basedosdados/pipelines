...
# Every .sql this script writes carries it, so the next person to open one of
# the ~85-column models knows a hand edit will not survive the next run.
HEADER = (
    f"-- Generated by models/{DATASET}/code/gen_dbt.py from code/sheet_<table>.tsv.\n"
