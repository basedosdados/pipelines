...
select
    ...
    safe_cast(
        forma_contratacao_parceria_municipal_cooperacao_tecnica_financeira as int64
    ...
    safe_cast(
        forma_contratacao_parceria_estadual_cooperacao_tecnica_financeira as int64
    ...
    safe_cast(profissional_tradutor_libras as int64) profissional_tradutor_libras,
    safe_cast(
    ...
    safe_cast(quantidade_turma_medio_integral as int64) quantidade_turma_medio_integral,
