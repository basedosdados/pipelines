...
# The three data tables are hive-partitioned by year over 1950..2026 (77 files
# each); dicionario is a single file.
EXPECTED_FILES = {
    "event": 77,
    "fatality": 77,
    # 1950-1971 and 1973-1995 have no location rows and write no file.
    "event_location": 32,
    "dicionario": 1,
}
