...
select
    ...
    safe_cast(departamento_similar_existencia as string) departamento_similar_existencia,
    safe_cast(
    ...
    safe_cast(secretaria_associada_subordinada_obras as string) secretaria_associada_subordinada_obras,
    safe_cast(secretaria_associada_subordinada_pesca as string) secretaria_associada_subordinada_pesca,
    safe_cast(
        secretaria_associada_subordinada_planejamento as string
    ) secretaria_associada_subordinada_planejamento,
    safe_cast(secretaria_associada_subordinada_saude as string) secretaria_associada_subordinada_saude,
    safe_cast(
        secretaria_associada_subordinada_turismo as string
    ) secretaria_associada_subordinada_turismo,
    safe_cast(secretaria_associada_subordinada_outras as string) secretaria_associada_subordinada_outras,
    ...
    safe_cast(pessoal_ocupado_somente_comissionado as int64) pessoal_ocupado_somente_comissionado,
    safe_cast(pessoal_ocupado_outros as int64) pessoal_ocupado_outros,
    safe_cast(pessoal_ocupado_sem_vinculo_permanente as int64) pessoal_ocupado_sem_vinculo_permanente,
    safe_cast(capacitacao_uniao_ultimos_4anos as string) capacitacao_uniao_ultimos_4anos,
    safe_cast(capacitacao_area_estruturacao_gestao as string) capacitacao_area_estruturacao_gestao,
    safe_cast(capacitacao_area_licensiamento as string) capacitacao_area_licensiamento,
    safe_cast(capacitacao_area_educacao_ambiental as string) capacitacao_area_educacao_ambiental,
    safe_cast(
    ...
    safe_cast(capacitacao_area_residuos_solidos as string) capacitacao_area_residuos_solidos,
    safe_cast(
    ...
    safe_cast(capacitacao_area_recursos_hidricos as string) capacitacao_area_recursos_hidricos,
    safe_cast(
    ...
    safe_cast(conselho_reunioes_ultimos_12meses as int64) conselho_reunioes_ultimos_12meses,
    ...
    safe_cast(conselho_infraestrutura_computador as string) conselho_infraestrutura_computador,
    safe_cast(conselho_infraestrutura_impressora as string) conselho_infraestrutura_impressora,
    safe_cast(conselho_infraestrutura_internet as string) conselho_infraestrutura_internet,
    safe_cast(conselho_infraestrutura_veiculo as string) conselho_infraestrutura_veiculo,
    safe_cast(conselho_infraestrutura_telefone as string) conselho_infraestrutura_telefone,
    safe_cast(conselho_infraestrutura_diarias as string) conselho_infraestrutura_diarias,
    safe_cast(
    ...
    safe_cast(recursos_especificos_meio_ambiente as string) recursos_especificos_meio_ambiente,
    ...
    safe_cast(licensiamento_concedeu_ano_anterior as string) licensiamento_concedeu_ano_anterior,
    safe_cast(
    ...
    safe_cast(agenda21_processo_elaboracao_local as string) agenda21_processo_elaboracao_local,
    ...
    safe_cast(legislacao_questao_ambiental_forma as string) legislacao_questao_ambiental_forma,
    safe_cast(legislacao_coleta_seletiva as string) legislacao_coleta_seletiva,
    safe_cast(legislacao_coleta_seletiva_ano_criacao as int64) legislacao_coleta_seletiva_ano_criacao,
    safe_cast(legislacao_saneamento_basico as string) legislacao_saneamento_basico,
    safe_cast(legislacao_saneamento_basico_ano_criacao as int64) legislacao_saneamento_basico_ano_criacao,
    safe_cast(legislacao_gestao_bacias_hidrograficas as string) legislacao_gestao_bacias_hidrograficas,
    safe_cast(
        legislacao_gestao_bacias_hidrograficas_ano_criacao as int64
    ) legislacao_gestao_bacias_hidrograficas_ano_criacao,
    safe_cast(legislacao_area_protecao_ambiental as string) legislacao_area_protecao_ambiental,
    safe_cast(
    ...
    safe_cast(legislacao_poluicao_ar_ano_criacao as int64) legislacao_poluicao_ar_ano_criacao,
    safe_cast(
    ...
    safe_cast(legislacao_fauna_silvestre_ano_criacao as int64) legislacao_fauna_silvestre_ano_criacao,
    safe_cast(legislacao_florestas as string) legislacao_florestas,
    safe_cast(legislacao_florestas_ano_criacao as int64) legislacao_florestas_ano_criacao,
    safe_cast(legislacao_protecao_biodiversidade as string) legislacao_protecao_biodiversidade,
    safe_cast(
    ...
    safe_cast(implementacao_convenio_parceria as string) implementacao_convenio_parceria,
    safe_cast(
    ...
    safe_cast(implementacao_convenio_parceria_ong as string) implementacao_convenio_parceria_ong,
    safe_cast(
    ...
    safe_cast(implementacao_convenio_parceria_outro as string) implementacao_convenio_parceria_outro,
    safe_cast(articulacao_intermunicipal_consorcio as string) articulacao_intermunicipal_consorcio,
    safe_cast(
    ...
    safe_cast(
        articulacao_intermunicipal_comite_bacia_hidrografica_quantidade_comites as string
    ) articulacao_intermunicipal_comite_bacia_hidrografica_quantidade_comites,
    safe_cast(articulacao_intermunicipal_outro as string) articulacao_intermunicipal_outro,
    safe_cast(
    ...
    safe_cast(articulacao_temas_abordados_outros as string) articulacao_temas_abordados_outros,
    safe_cast(
    ...
    safe_cast(parceria_governo_federal_programas as string) parceria_governo_federal_programas,
    safe_cast(
    ...
    safe_cast(
        parceria_governo_federal_programas_sustentabilidade_instituicoes_publicas as string
    ...
    safe_cast(ceia_estadual_reuniao_ultimos_12meses as string) ceia_estadual_reuniao_ultimos_12meses,
    safe_cast(
    ...
    safe_cast(iniciativas_consumo_sustentavel as string) iniciativas_consumo_sustentavel,
    safe_cast(
    ...
    safe_cast(iniciativas_consumo_sustentavel_outras as string) iniciativas_consumo_sustentavel_outras,
    safe_cast(
    ...
    safe_cast(recursos_oriundos_empresa_publica as string) recursos_oriundos_empresa_publica,
    safe_cast(
    ...
    safe_cast(recursos_oriundos_iniciativa_privada as string) recursos_oriundos_iniciativa_privada,
    safe_cast(recursos_oriundos_outros as string) recursos_oriundos_outros,
    safe_cast(recursos_oriundos_orgao_publico as string) recursos_oriundos_orgao_publico,
    safe_cast(
        recursos_oriundos_orgao_publico_taxa_licensiamento as string
    ) recursos_oriundos_orgao_publico_taxa_licensiamento,
    safe_cast(recursos_oriundos_orgao_publico_multas as string) recursos_oriundos_orgao_publico_multas,
    safe_cast(
    ...
    safe_cast(recursos_oriundos_orgao_publico_outros as string) recursos_oriundos_orgao_publico_outros,
    safe_cast(ocorrencia_impactante_ultimos_24meses as string) ocorrencia_impactante_ultimos_24meses,
    safe_cast(
    ...
    safe_cast(
        ocorrencia_impactante_ultimos_24meses_reducao_quantidade_diversidade_pescado as string
    ...
    safe_cast(servicos_recebe_recursos_pagamento as string) servicos_recebe_recursos_pagamento,
    safe_cast(
        servicos_recebe_recursos_pagamento_municipio as string
    ) servicos_recebe_recursos_pagamento_municipio,
    safe_cast(servicos_recebe_recursos_pagamento_uniao as string) servicos_recebe_recursos_pagamento_uniao,
    safe_cast(servicos_recebe_recursos_pagamento_estado as string) servicos_recebe_recursos_pagamento_estado,
    safe_cast(
    ...
    safe_cast(servicos_recebe_recursos_pagamento_ong as string) servicos_recebe_recursos_pagamento_ong,
    safe_cast(
        servicos_recebe_recursos_pagamento_doacoes as string
    ) servicos_recebe_recursos_pagamento_doacoes,
    safe_cast(servicos_recebe_recursos_pagamento_outros as string) servicos_recebe_recursos_pagamento_outros,
    ...
    safe_cast(servicos_paga_instrumento_outros as string) servicos_paga_instrumento_outros,
