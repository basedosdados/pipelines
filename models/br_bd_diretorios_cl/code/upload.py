#!/usr/bin/env python3
"""Upload br_bd_diretorios_cl parquet (region, provincia, comuna) to BigQuery staging.

Usage:
    uv run python models/br_bd_diretorios_cl/code/upload.py [--env dev|prod] [table ...]
"""
...
DATASET_ID = "br_bd_diretorios_cl"
OUT = (
    Path(
        os.environ.get(
            "CL_DIR_DATA",
            Path.home() / "Downloads" / "br_bd_diretorios_cl_data",
        )
    )
    / "output"
)
TABLES = ["region", "provincia", "comuna"]
