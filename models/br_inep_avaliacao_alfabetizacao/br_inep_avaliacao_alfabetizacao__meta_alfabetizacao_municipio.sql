{{
    config(
        alias="meta_alfabetizacao_municipio",
...
select
    ...
    safe_cast(nivel_alfabetizacao as int64) nivel_alfabetizacao,
    safe_cast(percentual_participacao as float64) percentual_participacao,
from
    {{
        set_datalake_project(
            "br_inep_avaliacao_alfabetizacao_staging.meta_alfabetizacao_municipio"
        )
    }}
