{{
    config(
        ...
        alias="data_profile_congressional_district",
        materialized="table",
        partition_by={
            "field": "year",
            "data_type": "int64",
        ...
        cluster_by=["id_state", "id_congressional_district", "variable_code"],
    )
}}
...
from
    {{
        set_datalake_project(
            "us_census_acs_staging.data_profile_congressional_district"
        )
    }} as t
