"""Upload cleaned us_epu_gpr parquet tables to BigQuery.

Usage:
    uv run --no-project python models/us_epu_gpr/code/upload.py [--env dev|prod] [table_slug ...]
...
Scratch output lives under ``~/Downloads/us_epu_gpr_data/output`` (overridable
with ``EPU_GPR_DATA_DIR``).
"""
