#!/usr/bin/env python3
"""Upload the cleaned br_ibama_fiscalizacao parquet to BigQuery staging.

Usage::

    python upload.py                      # all tables, dev
    python upload.py auto_infracao area_embargada        # a subset
    python upload.py --env prod           # only after explicit approval

The dicionario is a dbt model over the facts and is deliberately not uploaded.
"""
