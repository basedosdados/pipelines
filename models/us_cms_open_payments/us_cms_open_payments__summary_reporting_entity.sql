...
select
    ...
    safe_cast(
        general_transaction_count_physician as string
    ) general_transaction_count_physician,
    safe_cast(
        general_transaction_count_non_physician_practitioner as string
    ) general_transaction_count_non_physician_practitioner,
    safe_cast(
        general_transaction_count_teaching_hospital as string
    ) general_transaction_count_teaching_hospital,
    safe_cast(research_transaction_count as int64) research_transaction_count,
    safe_cast(
        research_transaction_count_physician as string
    ) research_transaction_count_physician,
    safe_cast(
        research_transaction_count_non_physician_practitioner as string
    ) research_transaction_count_non_physician_practitioner,
    safe_cast(
        research_transaction_count_teaching_hospital as string
