...
expects, generated from the schema module so the backend cannot drift from the
architecture CSVs or the dbt models.
"""
...
def main() -> int:
    ...
    for table, columns in TABLES.items():
        ...
        summary[table] = {
            ...
            "partition_columns": [c.name for c in columns if c.name == "year"],
