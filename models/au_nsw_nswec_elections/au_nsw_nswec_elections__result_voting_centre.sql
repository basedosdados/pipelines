...
select
    ...
    safe_cast(votes_above_the_line as int64) votes_above_the_line,
    safe_cast(votes_below_the_line as int64) votes_below_the_line,
...
from
    {{ set_datalake_project("au_nsw_nswec_elections_staging.result_voting_centre") }}
    as t
